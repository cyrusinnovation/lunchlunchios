...
- (void)testParseLunches {
    ...
    Location *expectedLocation1 = [[Location alloc] initWithId:@"53252" name:@"Ashley's" address:@"338 S State St" andZipCode:@"48104"];
    Location *expectedLocation2 = [[Location alloc] initWithId:@"2623634cf5" name:@"Kosmos" address:@"407 N 5th Ave" andZipCode:@"48104"];
    ...
    NSString *id1 =@"4124124";
    NSDictionary *lunch1Dictionary = [NSDictionary dictionaryWithObjectsAndKeys:id1, @"_id",person1Dictionary, @"person1", person2Dictionary, @"person2", dateString1, @"dateTime", locationDictionary2, @"location", nil];
    NSString *dateString2 = @"2017-11-05T13:00:00.000Z";
    NSString *id2 =@"44534xcs124124";
    NSDictionary *lunch2Dictionary = [NSDictionary dictionaryWithObjectsAndKeys:id2, @"_id",person3Dictionary, @"person1", person2Dictionary, @"person2", dateString2, @"dateTime", locationDictionary1, @"location", nil];
    NSString *dateString3 = @"2017-12-01T20:00:00.000Z";
    NSString *id3 =@"4dsf124124";
    NSDictionary *lunch3Dictionary = [NSDictionary dictionaryWithObjectsAndKeys:id3, @"_id",person3Dictionary, @"person1", person1Dictionary, @"person2", dateString3, @"dateTime", locationDictionary2, @"location", nil];
    ...
    [self checkLunchAtIndex:expectedPerson1 expectedPerson2:expectedPerson2 dateString:dateString1 location:expectedLocation2 id:id1 allLunches:allLunches index:0];
    [self checkLunchAtIndex:expectedPerson3 expectedPerson2:expectedPerson2 dateString:dateString2 location:expectedLocation1 id:id2 allLunches:allLunches index:1];
    [self checkLunchAtIndex:expectedPerson3 expectedPerson2:expectedPerson1 dateString:dateString3 location:expectedLocation2 id:id3 allLunches:allLunches index:2];
...
- (void)testParseLunches_WillIgnoreAnyIncompleteLunchEntries {
    ...
    Location *expectedLocation = [[Location alloc] initWithId:@"62354" name:@"Ashley's" address:@"338 S State St" andZipCode:@"48104"];

    NSDictionary *locationDictionary = [self buildLocationDictionary:expectedLocation];

    NSString *dateString1 = @"2017-11-07T12:30:00.000Z";
    NSString *expectedID = @"tahssasaid";
    NSDictionary *goodLunchDictionary = [NSDictionary dictionaryWithObjectsAndKeys:expectedID, @"_id", person1Dictionary, @"person1", person2Dictionary, @"person2", dateString1, @"dateTime", locationDictionary, @"location", nil];

    NSDictionary *noPerson1Dictionary = [NSDictionary dictionaryWithObjectsAndKeys:expectedID, @"_id",person2Dictionary, @"person2", dateString1, @"dateTime", locationDictionary, @"location", nil];
    NSDictionary *noPerson2Dictionary = [NSDictionary dictionaryWithObjectsAndKeys:expectedID, @"_id",person1Dictionary, @"person1", dateString1, @"dateTime", locationDictionary, @"location", nil];
    NSDictionary *noDateTimeDictionary = [NSDictionary dictionaryWithObjectsAndKeys:expectedID, @"_id",person1Dictionary, @"person1", person2Dictionary, @"person2", locationDictionary, @"location", nil];
    NSDictionary *noIdDictionary = [NSDictionary dictionaryWithObjectsAndKeys: person1Dictionary, @"person1", person2Dictionary, @"person2", dateString1, @"dateTime", locationDictionary, @"location", nil];


    NSArray *arrayOfLunchDictionaries = [NSArray arrayWithObjects:goodLunchDictionary, noPerson1Dictionary,
                                                                  noPerson2Dictionary, noDateTimeDictionary,noIdDictionary, nil];

    NSData *data = [NSJSONSerialization dataWithJSONObject:arrayOfLunchDictionaries options:NSJSONWritingPrettyPrinted error:nil];
    NSArray *allLunches = [[LunchParser singleton] parseLunches:data];
    XCTAssertEqual(1, [allLunches count]);
    [self checkLunchAtIndex:person1 expectedPerson2:person2 dateString:dateString1 location:expectedLocation id:expectedID allLunches:allLunches index:0];
...
- (void)testParseLunches_WillAcceptLunchesWithNullLocation {
    ...
    Location *expectedLocation = [[Location alloc] initWithId:@"643sd423" name:@"Ashley's" address:@"338 S State St" andZipCode:@"48104"];

    NSDictionary *locationDictionary = [self buildLocationDictionary:expectedLocation];

    NSString *dateString1 = @"2017-11-07T12:30:00.000Z";
    NSString *id1 =@"412tsdg4124";
    NSString *id2 =@"1254124124";
    NSDictionary *goodLunchDictionary = [NSDictionary dictionaryWithObjectsAndKeys: id1, @"_id",person1Dictionary, @"person1", person2Dictionary, @"person2", dateString1, @"dateTime", locationDictionary, @"location", nil];
    NSDictionary *noLocationDictionary = [NSDictionary dictionaryWithObjectsAndKeys:id2, @"_id",person1Dictionary, @"person1", person2Dictionary, @"person2", dateString1, @"dateTime", nil];
    ...
    [self checkLunchAtIndex:person1 expectedPerson2:person2 dateString:dateString1 location:expectedLocation id:id1 allLunches:allLunches index:0];
    [self checkLunchAtIndex:person1 expectedPerson2:person2 dateString:dateString1 location:[NullLocation singleton] id:id2 allLunches:allLunches index:1];
}
...
- (void)testBuildLunchJSON {
    ...
    Lunch *lunch = [[Lunch alloc] initWithId:@"doesntmatter" person1:person1 person2:person2 dateTime:theNotToDistantFuture andLocation:nil];
...
- (void)checkLunchAtIndex:(Person *)expectedPerson1 expectedPerson2:(Person *)expectedPerson2 dateString:(NSString *)dateString location:(NSObject <LocationProtocol> *)expectedLocation id:(NSString *)expectedId allLunches:(NSArray *)allLunches index:(int)index {
    ...
    XCTAssertEqualObjects(expectedId, [lunch getId]);
