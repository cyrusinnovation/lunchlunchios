...
- (void)testWillShowLunchDetailsOnViewDidLoad {
    ...
    self.viewController.lunch = [[Lunch alloc] initWithPerson1:loggedInPerson person2:lunchBuddy dateTime:date andLocation:nil ];
...
- (void)testWillShowLocationDetailsOnViewDidLoad {
    ...
    self.viewController.lunch = [[Lunch alloc] initWithPerson1:loggedInPerson person2:[[Person alloc] init] dateTime:date andLocation:location ];
    [self.viewController viewDidLoad];
...
- (void)testWillShowLunchDetailsOnViewDidLoad_LoggedInPersonIsPerson2 {
    ...
    self.viewController.lunch = [[Lunch alloc] initWithPerson1:lunchBuddy person2:loggedInPerson dateTime:date andLocation:nil ];
    [self.viewController viewDidLoad];
