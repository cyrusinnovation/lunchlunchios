...
@interface OldLunchProviderTest : XCTestCase
@end

@implementation OldLunchProviderTest {
...
- (void)testFindLunchesWillReturnLunchesThatThePersonIsAPartOf {
    ...
    OldLunchProvider *lunchProvider = [[OldLunchProvider alloc] initWithLunchRetriever:mockLunchRetriever];
